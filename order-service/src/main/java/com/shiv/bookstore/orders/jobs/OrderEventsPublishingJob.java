...
import com.shiv.bookstore.orders.domain.OrderEventService;
...
public class OrderEventsPublishingJob {
    ...
    public void publishOrderEvents(OrderCreatedEvent event){
        log.info("Publishing Orders Event at {}" , Instant.now());
